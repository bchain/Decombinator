...
REM barcodes are at the end of the read. e.g. 250 : 278; or 250 :256
FOR /f %%A IN ('DIR /B *.fastq')DO decombinatorV2_2.py -i %%A  -o %%A -b True -bs1 0 -be1 6 -bs2 6 -be2 6 -p True -c True -of True -f True -s mouse
